...
export default function VoiceChat({ relocationData }) {
  ...
  // Format text for display (convert markdown to readable format)
  ...
  const handleSendMessage = async (text = inputText) => {
    ...
    try {
      ...
      // Speak the response (clean all formatting for speech)
    ...
    <div className="glass-card p-6 h-[600px] flex flex-col">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          title={isSpeaking ? 'Stop speaking' : 'Speaker off'}
        >
            ...
            >
              <div 
                ...
                dangerouslySetInnerHTML={{ 
                  __html: formatTextForDisplay(msg.content) 
                }}
              />
